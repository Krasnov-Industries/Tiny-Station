...
book-text-atmos-vents =
    Ниже приведён краткий справочник по нескольким атмосферным устройствам:

                Пассивные вентиляторы:
                Этим вентиляторам не нужно питание, они позволяют газам свободно перетекать как внутрь подключённой трубопроводной сети, так и наружу.

                Активные вентиляторы:
                Самые распространённые вентиляторы на станции. У них есть внутренний насос, и им требуется питание. По умолчанию они нагнетают газы только из труб и только до 101 кПа. Однако их можно перенастроить с помощью воздушной сигнализации. Они также блокируются, если давление в помещении ниже 1 кПа, чтобы не нагнетать газ в космос.

                Воздушные скрубберы:
                Эти устройства позволяют удалять газы из среды и направлять их в подключённую трубопроводную сеть. При подключении к воздушной сигнализации их можно настроить на отбор конкретных газов.

                Воздушные инжекторы:
                Инжекторы похожи на активные вентиляторы, но у них нет внутреннего насоса и им не требуется питание. Их нельзя настроить, но они способны нагнетать газы до гораздо большего давления.
