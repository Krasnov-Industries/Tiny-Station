...
nukeops-welcome =
    Вы — ядерный оперативник. Ваша цель — взорвать {$station} и убедиться, что от неё осталась лишь груда обломков. Ваше начальство, Синдикат, снабдило вас всем необходимым для задания.
