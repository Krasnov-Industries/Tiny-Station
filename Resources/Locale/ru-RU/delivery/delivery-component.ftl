...
delivery-unlocked-others = {CAPITALIZE($recipient)} разблокировал(а) {$delivery} {POSS-ADJ($possadj)} отпечатком пальца.
...
delivery-teleporter-amount-examine =
    { $amount ->
        [one] Внутри [color=yellow]{$amount}[/color] посылка.
        *[other] Внутри посылок: [color=yellow]{$amount}[/color].
    }
