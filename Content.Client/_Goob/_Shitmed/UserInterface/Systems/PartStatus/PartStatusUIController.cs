...
using Content.Client._Goob._Shitmed.UserInterface.Systems.PartStatus.Widgets;
using Content.Shared._Goob._Shitmed.PartStatus.Events;
using Content.Shared._Goob._Shitmed.Targeting;
using Content.Client._Goob._Shitmed.Targeting;
...
namespace Content.Client._Goob._Shitmed.UserInterface.Systems.PartStatus;
