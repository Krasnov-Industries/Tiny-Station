...
public sealed partial class BlobChemSwapMenu : DefaultWindow
{
    ...
    private Shared._Goobstation.Blob.BlobChemColors _possibleChems = new();
    ...
    public void UpdateState(Shared._Goobstation.Blob.BlobChemColors chemList, BlobChemType selectedChem)
    {
    ...
    internal void PdaUpdateState(BlobChemColors chemList, BlobChemType selectedChem)
    {
