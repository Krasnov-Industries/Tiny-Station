...
public sealed partial class GhettoSurgerySystem : EntitySystem
{
    ...
    private void OnSharpInit(Entity<SharpComponent> ent, ref MapInitEvent args)
    {
        ...
        {
            tool.StartSound = new SoundPathSpecifier("/Audio/_Goob/Shitmed/Medical/Surgery/scalpel1.ogg");
            tool.EndSound = new SoundPathSpecifier("/Audio/_Goob/Shitmed/Medical/Surgery/scalpel2.ogg");
