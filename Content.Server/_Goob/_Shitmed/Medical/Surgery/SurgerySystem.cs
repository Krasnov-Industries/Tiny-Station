...
using Content.Shared._Goob._Shitmed.Damage;
...
namespace Content.Server._Goob._Shitmed.Medical.Surgery;
...
public sealed class SurgerySystem : SharedSurgerySystem
{
        ...
        bool affectAll = false)
    {
        ...
        if (partMultiplier != 1f)
        {
            foreach (var key in damage.DamageDict.Keys.ToList())
            {
                damage.DamageDict[key] *= partMultiplier;
            }
        }
