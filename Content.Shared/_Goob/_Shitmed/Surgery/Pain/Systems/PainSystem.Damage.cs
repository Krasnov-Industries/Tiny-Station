...
using Content.Shared._Goob._Shitmed.Medical.Surgery.Consciousness;
using Content.Shared._Goob._Shitmed.Medical.Surgery.Consciousness.Components;
...
namespace Content.Shared._Goob._Shitmed.Medical.Surgery.Pain.Systems;
...
public partial class PainSystem
{
    ...
    private void UpdateDamage(EntityUid nerveSysEnt, NerveSystemComponent nerveSys)
    {
        ...
        {
            var ev = new MobThresholdChecked(body, mobState, thresholds, damageable);
    ...
    private void ApplyPainReflexesEffects(EntityUid body, Entity<NerveSystemComponent> nerveSys, PainThresholdTypes reaction)
    {
        ...
        switch (reaction)
        {
            ...
            case PainThresholdTypes.PainShock:
                ...
                _stun.TryAddParalyzeDuration(body, nerveSys.Comp.PainShockStunTime);
            ...
            case PainThresholdTypes.PainShockAndAgony:
                ...
                _stun.TryAddParalyzeDuration(body, nerveSys.Comp.PainShockStunTime * 1.4);
