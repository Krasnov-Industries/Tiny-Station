...
namespace Content.Shared._Goob._Shitmed.Medical.Surgery.Tools;
...
public sealed class SurgeryToolExamineSystem : EntitySystem
{
    ...
    private void OnExamined<T>(EntityUid uid, T comp, ref SurgeryToolExaminedEvent args) where T : Component, ISurgeryToolComponent
    {
