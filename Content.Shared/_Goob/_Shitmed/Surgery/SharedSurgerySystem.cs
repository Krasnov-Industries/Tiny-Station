...
using System.Linq;
using Content.Shared._Goob._Shitmed.Medical.Surgery.Conditions;
using Content.Shared._Goob._Shitmed.Medical.Surgery.Consciousness.Systems;
using Content.Shared._Goob._Shitmed.Medical.Surgery.Pain.Systems;
using Content.Shared._Goob._Shitmed.Medical.Surgery.Steps;
using Content.Shared._Goob._Shitmed.Medical.Surgery.Steps.Parts;
using Content.Shared._Goob._Shitmed.Medical.Surgery.Wounds.Systems;
using Content.Shared._Goob._Shitmed.Medical.Surgery.Wounds.Components;
using Content.Shared._Goob._Shitmed.Medical.Surgery.Traumas.Systems;
using Content.Shared._Goob._Shitmed.Surgery;
...
namespace Content.Shared._Goob._Shitmed.Medical.Surgery;
