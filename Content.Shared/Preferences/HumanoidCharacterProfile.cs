...
namespace Content.Shared.Preferences
{
    ...
    public sealed partial class HumanoidCharacterProfile
    {
        ...
        private static readonly Regex RestrictedNameRegex = new(@"[^\p{L}\p{N} '\-]");
        ...
        [DataField]
        public ProtoId<BarkPrototype>? BarkVoice { get; private set; }
        ...
        // SpaceDream added start - speech barks profile preference
        public HumanoidCharacterProfile WithSpeechBark(ProtoId<BarkPrototype>? bark)
        {
            return new(this) { BarkVoice = bark };
        }
        // SpaceDream added end
        ...
        public void EnsureValid(ICommonSession session, IDependencyCollection collection)
        {
            ...
            if (barkVoice != null && !prototypeManager.HasIndex(barkVoice))
                barkVoice = null;
            // SpaceDream added end
