...
| Large subsystem docs | Dividing a large system into partial parts with a separate area of ​​responsibility | abstract `Shared*System` families (e.g. `SharedDoorSystem`) | 2026-01-24 | Use |
| Cross-system docs | Check for unusual API calls in system consumers | callsites passing non-default boolean flags to `TryAddTarget(..., true, true)` | 2026-01-08 / 2025-11-29 | Use |
