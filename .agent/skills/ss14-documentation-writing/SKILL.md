...
6. Edit markers (`Tinystation edit start/end`, `Goobstation added start/end`) instead of behavioral description.
...
if (!_door.TryAddTarget((uid, door), args.User, true, true))
    continue;
```
